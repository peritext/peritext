...
var contextualizeInlineStatic = exports.contextualizeInlineStatic = function contextualizeInlineStatic(inputDocument, inputContextualization, settings) {
  ...
  var data = document.data[contextualization.resources[0]];
  ...
  if (!contextualization.sectionOpCit) {
    ...
    if (settings.figuresPosition === 'inline') {
      (function () {
        ...
        var newNodePath = [sectionId, 'contents', nodeBlockIndex + 1];
 ...
 * @return {Object} newDocument - the updated representation of the peritext document in which the contextualization was made
 */
var contextualizeInlineDynamic = exports.contextualizeInlineDynamic = function contextualizeInlineDynamic(inputDocument, inputContextualization, settings) {
  return Object.assign({}, inputDocument);
};
 ...
 * @return {Object} newDocument - the updated representation of the peritext document in which the contextualization was made
 */
var contextualizeBlockDynamic = exports.contextualizeBlockDynamic = function contextualizeBlockDynamic(inputDocument, inputContextualization, settings) {
  return Object.assign({}, inputDocument);
};